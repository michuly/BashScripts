...
fluxes_script="/analysis/michalshaham/PythonProjects/Oceanography/scripts/analyze_data/Flx_calc_temporal.py"
...
output_files=( /analysis/michalshaham/BashScripts/Output_files/output_time{1..14}.txt )
